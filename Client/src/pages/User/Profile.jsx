        ...
        <HomeLayout>
            <div className='bg-gray-600  text-white flex justify-center items-center min-h-[81.5vh] select-none  '>
                <div className='border-white bg-slate-100 rounded-md p-3 w-[40vw] '>
                    <h1 className=' text-red-300  font-bold underline p-2  text-center lg:md:text-2xl sm:text-[24px] text-[20px] '>WelCome {data?.user?.role}</h1>
                    <div className='  '>
                        <img src={data?.user?.avatar?.secure_url} className='bg-red-400 p-1 w-20  h-20 m-auto rounded-full' alt="" />
                    </div>
                    ...
                    Name: <h1 className='text-red-300 ml-1 cursor-default select-none '>{data?.user?.fullName}</h1>
                    </div>
                    ...
                    Email: <h1 className='text-red-300 ml-1 filter blur-sm hover:blur-none  cursor-not-allowed '>{data?.user?.email}</h1>
                    </div>
