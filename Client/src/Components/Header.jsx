                    ...
                    isLogin ?
                        <div onClick={toogle?showOptions:showOptions2nd} className='  relative right-8    '>
                            <div className='bg-red-400 w-[42px] h-[42px]  rounded-full  '>
                                <img src={data.user.avatar.secure_url} className='  w-[40px] h-[40px]  rounded-full hover:scale-[1.08] transition-all duration-200  ' alt="" />
                            </div>
                            <div id='showDetails' className='hidden flex-col justify-center items-center w-[full]   text-center h-[full] rounded-[10px] bg-gray-800'>
                        ...
                        :
                        <div className='relative right-8 hover:bg-red-600 hover:scale-110 transition-all ease-linear duration-200 bg-red-500 rounded-[6px] border-[1px solid red] p-[7px] '>
